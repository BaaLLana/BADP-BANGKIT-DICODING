...
def sidebar(df):
    ...
    with st.sidebar:
        st.image("https://raw.githubusercontent.com/HakimIqbal/BADP-BANGKIT-DICODING/master/Submission/dashboard/Capital Bikeshare Logo.png")
...
if __name__ == "__main__":
    ...
    copyright = "Copyright © " + str(year_copyright) + " | Bike Sharing Dashboard | All Rights Reserved | " + "Made with :heart: by [@HakimIqbal](https://www.linkedin.com/in/muhiqbalhakim/)"
